...
function createPlacesGrid(place_image,place_alternative_text,place_title,place_details)
{
  ...
  thumbnail.src=place_image;
  thumbnail.alt=place_alternative_text;
  ...
  title.innerText=place_title;
  cardData.appendChild(title);

  var card_text=document.createElement('p');
  card_text.classList.add('cardText');
  card_text.innerText=place_details;
  cardData.appendChild(card_text);
...
//Loop to print multiple cards
for(var i=0;i<cards.length;i++)
{
//create main card
var placeCard=createPlacesGrid(cards[i].imgUrl,cards[i].imgAlt,cards[i].header,cards[i].description);
mainGrid.appendChild(placeCard);
}
